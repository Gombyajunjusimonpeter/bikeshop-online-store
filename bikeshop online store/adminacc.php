...
<head>
    ...
    <title>ADMIN | bikeshop Online store </title>
...
body {
  ...
  background-image:linear-gradient(rgba(0,0,0,0.8),rgba(0,0,0,0.5)), url('images/620583-bicycle-vehicle-closeup-blurred-brak-brake-748x499.jpg');
	height: 100vh;
  ...
  <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                <div class="navbar-header">
                   ...
                   <a href="index.php"><h4 class="wow fadeInDown" style="margin-top:20px; color:#FFF;"> <i class="fa fa-cogs"></i> bikeshop Online store </h4></a>
                </div>
    
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        <li class="dropdown"><a class="dropdown-toggle wow fadeInDown" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-th"></span> Adding / Updating bike <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                              <li><a href="addcnp.php"> Add bike </a></li>
                              <li><a href="update_cnp.php"> Update bike </a></li>
                            </ul>
                        </li>
...
<div class="container wow fadeInDown">
    <div class="row">
        ...
        <center><img src="images/PC240341.jpg" class="img-responsive wow fadeInDown" style="height:200px;  width: 50%;" /></center>
        <div>
            <?php
                session_start();
...
<!--*************************************************** FOOTERS **********************************************-->
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <center>&copy; 2020 <a target="_blank" href="#" title="#">bikeshop Online store</a>. All Rights Reserved.</center>
                </div>
            </div>
        </div>
    </footer><!--/#footer-->
