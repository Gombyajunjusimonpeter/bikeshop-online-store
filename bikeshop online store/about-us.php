...
<body>
      ...
      <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <img src="images/mtb-silhouette-white-264x300.png"  width="10% "/>  bikeshop Online store</h4></a>
                </div>
  ...
  <p class="lead"> The  bikeshop Online store operates an online  bike shop store selling  bikes. The company started 2020 as a small  bike shop to sell  first class bikes. The product line had expanded to include a number of bike brands used in wholesale and retail . Today, the company is one of the biggest whosale and retail stores of  bikes carrying quality brands. Its online business sites launched in the 3rd quarter of 2020 to accommodate the growing population of loyal and new customers who prefer to purchase via online . 
  ...
  <p class="lead">
    ...
    <p class="lead">
            ...
            To be the top of the mind trusted  bikeshop Online store nationwide.
        </p>

  <a class="btn btn-primary btn-lg" href="available.php" role="button">see our bikes</a>
</div>
