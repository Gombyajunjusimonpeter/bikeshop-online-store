            ...
            <div class="left wow fadeInDown">
               ...
               <div class="col-md-6">
                <p class="lead">
                    ...
                    <p style="color:Cyan;"><span style="font-size:20px; font-weight:bold; font-family:verdana; color:lightblue;">SIMON JUNJU</span>
                    <br><b style="color:greenyellow;">Address:</b> Rubag,kampala<b style="color:greenyellow;"><br>Tel/Phone:</b> +256706567166 / +25673462320<b style="color:greenyellow;"><br>Email Address:</b> 1simongombya@gmail.com</p>
                    <hr>
